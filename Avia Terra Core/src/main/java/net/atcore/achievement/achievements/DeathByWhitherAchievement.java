...
public class DeathByWhitherAchievement extends BaseAchievementSimple<PlayerDeathEvent> implements SynchronouslyEvent {
    public DeathByWhitherAchievement() {
        super(Material.WITHER_ROSE, RootAchievement.class, AdvancementType.TASK);
    }
