...
public enum Message {
    ...
    COMMAND_PREMIUM_IS_PREMIUM("command.premium", "Esta cuenta ya es premium"),
    COMMAND_PREMIUM_IS_CRACKED("command.premium", "El nombre de usuario no pertenece a mojang"),
    COMMAND_PREMIUM_SUCCESSFUL("command.premium","Ya se hizo el cambio de tu cuenta. Ya es premium, vuelve a entrar"),
    COMMAND_CONFIRM_NOT_FOUND("command.confirm", "No tienes comandos por confirmar"),
    COMMAND_PASSIVE_RESTART_CANCEL("command.passive", "El reseteo fue cancelado"),
    COMMAND_PASSIVE_RESTART_INIT("command.passive", "Se inicio el reseteo pasivo usa <|<click:suggest_command:/passiverestart cancel>/passiverestart cancel</click>|> para cancelar"),
    COMMAND_PASSIVE_RESTART_START("command.passive", "Se inicio el reinició"),
